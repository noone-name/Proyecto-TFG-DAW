    ...
    <div class="w-full">
            ...
            <div class="md:flex items-center justify-between py-2 px-8 md:px-12">
                <div class="flex justify-between items-center">
                    <div class="text-2xl font-bold text-gray-800 md:text-3xl">
                        <a href="{{ url('/dashboard') }}"> Asesoria Legal</a>
                    </div>
                    <div class="md:hidden">
                        <button type="button"
                    ...
                    @if (Route::has('login'))
                        @auth
                            <div class="text-2xl font-bold text-gray-800 md:text-3xl">
                                ...
                                class="px-4 py-3 bg-gray-900 text-gray-200 text-xs font-semibold rounded hover:bg-gray-800">Entrar en la aplicación</a>
                            </div>
                        @else
                            <div class="text-2xl font-bold text-gray-800 md:text-3xl">

                                <a href="{{ route('login') }}"
                                class="px-4 py-3 bg-gray-900 text-gray-200 text-xs font-semibold rounded hover:bg-gray-800">Iniciar Sesión</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                    class="px-4 py-3 bg-gray-900 text-gray-200 text-xs font-semibold rounded hover:bg-gray-800">Registrarse</a>
                                @endif
                            </div>
                        @endauth
                    @endif
            ...
            <div class="container px-6 py-10 mx-auto">
                <div class="lg:flex lg:items-center">
                    <div class="w-full space-y-12 lg:w-1/2 ">
                        <div>
                            <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Descubre
                                nuestros
                                <br> maravillosos componentes
                            </h1>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white"> Gestión de
                                    citas</h1>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Gestión de Casos
                                </h1>
        ...
        <div class="flex bg-white" style="height:600px;">
            <div class="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800 md:text-4xl">Trabaja a tu manera! <span
                            class="text-indigo-600">Que nadie te pare</span></h2>
                    ...
                    <div class="flex justify-center lg:justify-start mt-6">
                        ...
                        @else
                            <div class="text-2xl font-bold text-gray-800 md:text-3xl">
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                    class="mx-4 px-4 py-3 bg-gray-300 text-gray-900 text-xs font-semibold rounded hover:bg-gray-400">Registrarse</a>
                                @endif
                            </div>
                        @endauth
                    @endif
