                        ...
                        @auth
                            <div class="text-2xl font-bold text-gray-800 md:text-3xl">
                                <a href="{{ url('/dashboard') }}"
                                    class="text-xl text-gray-700 dark:text-gray-500 underline">Entrar en la aplicación</a>
                            </div>
                        @else
                    <div class="text-2xl font-bold text-gray-800 md:text-3xl">

                            <a href="{{ route('login') }}" class="text-xl  text-gray-700 dark:text-gray-500 underline">Iniciar Sesión</a>

                            @if (Route::has('register'))

                                    <a href="{{ route('register') }}" class="text-xl text-gray-700 dark:text-gray-500 underline">Registrarse</a>
        ...
        <div class="container px-6 py-10 mx-auto">
            <div class="lg:flex lg:items-center">
                <div class="w-full space-y-12 lg:w-1/2 ">
                    <div>
                        <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">explore
                            our <br> awesome Components</h1>
