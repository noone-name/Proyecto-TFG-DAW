<div>
    ...
    <div class="bg-purple-100 rounded-lg py-5 px-6 mb-3 text-base text-purple-700 inline-flex items-center w-full"
        role="alert">
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" class="w-4 h-4 mr-2 fill-current"
    ...
    <div class="bg-gray-300 rounded-lg py-5 px-6 mb-3 text-base text-gray-800 inline-flex items-center w-full"
        role="alert">
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="gem" class="w-4 h-4 mr-2 fill-current"
