...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <a href="{{route('dashboard')}}" class=" font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline">Gestoria
                 <br>Admin Panel
            </a>
                    ...
                    <x-jet-dropdown >
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="mt-2 flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
