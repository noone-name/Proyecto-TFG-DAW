...
class Order extends Model
{
    ...
    {
        return $this->belongsToMany(Role::class, 'orders', 'user_id_cliente', 'user_id_abogado');
    }

    public function client()
    {
        return $this->belongsToMany(Role::class, 'orders', 'user_id_abogado', 'user_id_cliente');
    }
